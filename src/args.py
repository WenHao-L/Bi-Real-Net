...
def parse_arguments():
    """parse_arguments"""
    global args
    parser = argparse.ArgumentParser(description="MindSpore Bi-Real-Net Training")

    parser.add_argument("-a", "--arch", metavar="ARCH", default="birealnet34",
    ...
    parser.add_argument('--lr_lambda', default=None, help='result folder to save/load')   
